        ...
        <div class="card p-2 position-relative w-50 shadow border-0">
            ...
            <form action="" method="post" class="position-relative">
                ...
                <div class="m-3">
                    ...
                    <input type="number" class="form-control" id="stud-numeric" placeholder="1 or 2 or 3 ....etc">
                </div>
                <div class="m-3">
                    <label for="stud-section">Section</label>
                    <input type="text" class="form-control" id="stud-section" placeholder="A or B or C ....etc">
                </div>
